...
public class StartRpcServer {
    ...
    public static void main(String[] args) {
        ...
        CharityCaseRepository caseRepo = new CharityCaseHibernateRepository();
        ...
        TeledonServicesImpl teledonServerImpl = new TeledonServicesImpl(volunteerRepo, donorRepo, caseRepo, donationRepo);
